<template>
  <div class="container">
    <div class="title" :style="comStyle">
      <span>{{ '▎ ' + showTitle }}</span><span class="iconfont icon" @click="showChoice = !showChoice" :style="comStyle">&#xe6eb</span>
      <div class="con" v-show="showChoice">
        <div v-for="item in selectTypes" :key="item.key" @click="handleSelect(item.key)" :style="marginStyle">{{ item.text }}</div>
      </div>
    </div>
