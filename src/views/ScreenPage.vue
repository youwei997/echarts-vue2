<template>
  <div class="screen-container" :style="containerColor">
    ...
    <div class="screen-body">
      <section class="screen-left">
        ...
        >
          ...
          <div class="resize">
            <!-- 点击全屏图标：icon-expand-alt，退出全屏图标：icon-compress-alt -->
            <span
              @click="changeRize('trend')"
              :class="[
                'iconfont',
...
export default {
  ...
  methods: {
    changeRize(chartName) {
      //1.改变fullScreenStatus数据
      //2.需要调用图表组件的screenAdapter方法
      // this.fullScreenStatus[chartName] = !this.fullScreenStatus[chartName];
      // console.log(this.$refs[chartName].screenAdapter);
      // this.$nextTick(()=>{
